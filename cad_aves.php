...
<h1 style="display:flex;justify-content:center;align-items:center";>AVES</h1>
...
<center>
		<form method="POST" action="cad_birds.php" enctype="multipart/form-data">
...
<br>
  <br><br><br><br>
  <section class="caixa" id="ave">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="https://cdn.pixabay.com/photo/2018/09/28/09/55/animals-3708853_960_720.png" class="img-fluid" width="" height="100px">
          </div>
